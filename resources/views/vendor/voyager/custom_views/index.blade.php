...
<div class="page-content">
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;font-size: 18px;">All Product Sales Chart</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                ...
                <hr>
                <code style="text-align: center; display:block;">This chart displays the amount of each product sold based on ALL orders.</code>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;font-size: 18px;">Earnings Overview</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                ...
                <hr>
                <code style="text-align: center; display:block;">This chart displays the trend of <strong>Earnings</strong> between each month</code>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-4 col-lg-5">
        <div class="card shadow mb-4">
            <!-- Card Header - Dropdown -->
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;font-size: 18px;">All Product Variants Sales Chart</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="chart-pie pt-4">
                    <canvas id="variantSales"></canvas>
                </div>
                <hr>
                <code style="text-align: center; display:block;">This chart displays the amount of each product variant sold based on ALL orders.</code>
            </div>
        </div>
    </div>
    <!-- Bar Chart -->
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary" style="text-align: center;font-size: 18px;">Amount of Orders per Month</h6>
            </div>
            <div class="card-body">
                <div class="chart-bar">
                ...
                <hr>
                <code style="text-align: center; display:block;">This chart displays the amount of Orders Placed per month.</code>
            </div>
        </div>
    </div>
    ...
    <div class="analytics-container">
        <?php $google_analytics_client_id = Voyager::setting("admin.google_analytics_client_id"); ?> @if (isset($google_analytics_client_id) && !empty($google_analytics_client_id)) {{-- Google Analytics Embed --}}
...
<!--/-/-/-/-/-/-/-/-/ 
    Charts.JS
-/-/-/-/-/-/-/-/-/-->
<script type="text/javascript" src="{{asset('js/datacharts.js')}}"></script>

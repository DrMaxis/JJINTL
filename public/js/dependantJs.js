...
__webpack_require__(/*! ./modernizr.js */ "./resources/js/modernizr.js");
...
!function (e, t, n) {
  ...
  function g(e, t, a, o) {
    ...
    for (p = e.length, f = 0; p > f; f++) {
      if (g = e[f], h = G.style[g], l(g, "-") && (g = c(g)), G.style[g] !== n) {
        ...
        if (G.style[g] != h) return i(), "pfx" == t ? g : !0;
      }
    }
  ...
  function y(e, t, n, a, o) {
    ...
    return r(t, "string") || r(t, "undefined") ? g(s, t, a, o) : (s = (e + " " + z.join(i + " ") + i).split(" "), v(s, t, n));
  }
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./resources/js/dependantJs.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
